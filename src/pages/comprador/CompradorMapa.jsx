    ...
    <CompradorLayout>
      <div className="max-w-screen-xl mx-auto space-y-4 h-full">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          ...
          {lastUpdate && <div className="flex items-center gap-2 text-xs text-slate-500 bg-white border border-slate-200 rounded-xl px-3 py-2"><RefreshCw size={13} className="text-emerald-500"/> Actualizado: {lastUpdate}</div>}
        </div>
